...
namespace ssvu
{
    namespace MPL
    {
        namespace Impl
        {
            ...
            {
                using Type = typename ConcatTest<
                    ListInt<>,
                                       ...
                                       TILast>
            {
                ...
                using Type = typename ReplaceAllOfSeqHlpr<
                    TS, TM, TN, Append2, ListInt<TIs...>, TI + TM::size>::Type;
            };

            template <typename TS, typename TM, typename TN>
            using ReplaceAllOfSeq =
                typename ReplaceAllOfSeqHlpr<TS, TM, TN, List<>,
