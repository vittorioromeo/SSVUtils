...
namespace ssvu
{
	namespace MPL
	{
		...
		template<typename T, typename... Ts> inline constexpr T getMin(T mA, T mB, Ts... mX) noexcept { return getMin<T>(mA, getMin<T>(mB, mX...)); }
		...
		template<typename T, typename... Ts> inline constexpr T getMax(T mA, T mB, Ts... mX) noexcept { return getMax<T>(mA, getMax<T>(mB, mX...)); }
		...
		template<typename T, T TN0, T TN1, T... Ts> inline constexpr T getMin() noexcept { return getMin<T, TN0, getMin<TN1, Ts...>()>(); }
		...
		template<typename T, T TN0, T TN1, T... Ts> inline constexpr T getMax() noexcept { return getMax<T, TN0, getMax<TN1, Ts...>()>(); }
	}
}
