...
namespace ssvu
{
	namespace MPL
	{
		...
		template<typename T, typename... TArgs> inline constexpr T getMin(T mA, T mB, TArgs... mX) noexcept { return getMin(mA, getMin(mB, mX...)); }
		...
		template<typename T, typename... TArgs> inline constexpr T getMax(T mA, T mB, TArgs... mX) noexcept { return getMax(mA, getMax(mB, mX...)); }
		...
		template<typename T, T TN0, T TN1, T... TArgs> inline constexpr T getMin() noexcept { return getMin<TN0, getMin<TN1, TArgs...>()>(); }
		...
		template<typename T, T TN0, T TN1, T... TArgs> inline constexpr T getMax() noexcept { return getMax<TN0, getMax<TN1, TArgs...>()>(); }
	}
}
