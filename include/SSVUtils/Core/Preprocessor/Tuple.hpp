...
#define SSVPP_TPL_EXPLODE(mTpl)		SSVPP_DEFER(SSVPP_IMPL_TPL_EXPLODE mTpl)
...
#define SSVPP_IMPL_TPL_ELEM(mTpl, mIdx)			SSVPP_TKNCAT_2(SSVPP_IMPL_TPL_ELEM_, mIdx) SSVPP_DEFER(SSVPP_TPL_FILL(mTpl))
#define SSVPP_IMPL_TPL_ELEM_REVERSE(mTpl, mIdx)	SSVPP_TKNCAT_2(SSVPP_IMPL_TPL_ELEM_REVERSE_, mIdx) SSVPP_DEFER(SSVPP_TPL_FILL_REVERSE(mTpl))
...
#define SSVPP_IMPL_TPL_HEAD(mTpl)				SSVPP_DEFER(SSVPP_TPL_ELEM(mTpl, 0))
#define SSVPP_IMPL_TPL_TAIL(mTpl)				SSVPP_DEFER(SSVPP_TPL_ELEM_REVERSE(mTpl, 0))
#define SSVPP_IMPL_TPL_PUSH_BACK(mTpl, mArg)	SSVPP_DEFER(SSVPP_TPL_MAKE(SSVPP_TPL_EXPLODE(mTpl), mArg))
#define SSVPP_IMPL_TPL_PUSH_FRONT(mTpl, mArg)	SSVPP_DEFER(SSVPP_TPL_MAKE(mArg, SSVPP_TPL_EXPLODE(mTpl)))

#define SSVPP_TPL_FILL(mTpl)				( SSVPP_TPL_FILL_IMPL(mTpl) )
#define SSVPP_TPL_FILL_REVERSE(mTpl)		( SSVPP_TPL_FILL_REVERSE_IMPL(mTpl) )
#define SSVPP_TPL_ELEM(mTpl, mIdx)			SSVPP_DEFER(SSVPP_IMPL_TPL_ELEM(mTpl, mIdx))
#define SSVPP_TPL_ELEM_REVERSE(mTpl, mIdx)	SSVPP_DEFER(SSVPP_IMPL_TPL_ELEM_REVERSE(mTpl, mIdx))
