...
#define SSVPP_BITNOT(mX)		SSVPP_TKNCAT_2(SSVPP_IMPL_BITNOT_, SSVPP_DEFER(mX))
#define SSVPP_BITAND(m0, m1)	SSVPP_TKNCAT_3(SSVPP_IMPL_BITAND_, SSVPP_DEFER(m0), SSVPP_DEFER(m1))
#define SSVPP_BITOR(m0, m1)		SSVPP_TKNCAT_3(SSVPP_IMPL_BITOR_, SSVPP_DEFER(m0), SSVPP_DEFER(m1))
#define SSVPP_BITNOR(m0, m1)	SSVPP_TKNCAT_3(SSVPP_IMPL_BITNOR_, SSVPP_DEFER(m0), SSVPP_DEFER(m1))
#define SSVPP_BITXOR(m0, m1)	SSVPP_TKNCAT_3(SSVPP_IMPL_BITXOR_, SSVPP_DEFER(m0), SSVPP_DEFER(m1))
