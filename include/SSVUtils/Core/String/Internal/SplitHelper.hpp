...
template <>
struct SplitFindHelper<std::string> : public SplitFindHelperDefault<std::string>
{
};
...
template <Split TM, std::size_t TN>
...
template <Split TM>
struct SplitHelper<std::string, TM> : public SplitHelperImpl<std::string, TM>
{
    inline static void split(std::vector<std::string>& mTarget,
