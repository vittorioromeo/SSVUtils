...
const T& mX, EnableIf<!isSigned<T>()>* = nullptr) noexcept
{
    return 0 < mX;
}
...
template <typename T1, typename T2>
inline constexpr Common<T1, T2> getClampedMin(
...
template <typename T1, typename T2>
inline constexpr Common<T1, T2> getClampedMax(
...
/// mMax.
template <typename T1, typename T2, typename T3>
inline constexpr Common<T1, T2, T3> getClamped(
...
const T1& mStart, const T2& mEnd, const T3& mSpeed) noexcept
{
    using CT = Common<T1, T2, T3>;
    CT diff{
    getCycledValue(getWrapDeg(mEnd) - getWrapDeg(mStart), -CT(180), CT(180))};
...
/// columns.
template <typename T1, typename T2, typename T3>
inline constexpr Common<T1, T2, T3> get1DIdxFrom2D(
...
inline constexpr Common<T1, T2, T3, T4, T5> get1DIdxFrom3D(const T1& mX,
const T2& mY, const T3& mZ, const T4& mCols, const T5& mRows) noexcept
{
...
template <typename T1, typename T2, typename T3>
inline Common<T1, T2, T3> getMod(T1 mVal, const T2& mLB, const T3& mUB) noexcept
{
    SSVU_ASSERT(mLB < mUB);
...
inline constexpr Common<T1, T2, T3, T4> getDistSquaredEuclidean(
...
template <typename T1, typename T2, typename T3, typename T4>
inline constexpr Common<T1, T2, T3, T4> getDistEuclidean(
const T1& mX1, const T2& mY1, const T3& mX2, const T4& mY2) noexcept
{
...
/// @return Returns the calculated distance.
template <typename T1, typename T2, typename T3, typename T4>
inline constexpr Common<T1, T2, T3, T4> getDistManhattan(
const T1& mX1, const T2& mY1, const T3& mX2, const T4& mY2) noexcept
{
...
/// @return Returns the calculated distance.
template <typename T1, typename T2, typename T3, typename T4>
inline constexpr Common<T1, T2, T3, T4> getDistChebyshev(
const T1& mX1, const T2& mY1, const T3& mX2, const T4& mY2) noexcept
{
...
template <typename T1, typename T2, typename T3, typename T4>
inline constexpr Common<T1, T2, T3, T4> getRadTowards(
const T1& mX1, const T2& mY1, const T3& mX2, const T4& mY2) noexcept
{
...
template <typename T1, typename T2, typename T3, typename T4>
inline constexpr Common<T1, T2, T3, T4> getDegTowards(
const T1& mX1, const T2& mY1, const T3& mX2, const T4& mY2) noexcept
{
...
template <typename T1, typename T2>
inline constexpr Common<T1, T2> getDistRad(const T1& mA, const T2& mB) noexcept
{
...
template <typename T1, typename T2>
inline constexpr Common<T1, T2> getDistDeg(const T1& mA, const T2& mB) noexcept
{
...
template <typename T1, typename T2, typename T3, typename T4, typename T5>
inline constexpr Common<T1, T2, T3, T4, T5> getMap(const T1& mI,
...
/// @param mB Max value.
template <typename T1, typename T2, typename T3>
inline constexpr Common<T1, T2, T3> getLerp(
