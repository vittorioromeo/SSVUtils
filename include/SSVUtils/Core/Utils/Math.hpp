...
namespace ssvu
{
    ...
    /// value == 0.
    template <typename T>
    inline constexpr int getSign(const T& mX,
                                 EnableIf<!isSigned<T>()>* = nullptr) noexcept
    {
        return 0 < mX;
    }
    ...
    template <typename T1, typename T2>
    inline constexpr Common<T1, T2> getClampedMin(const T1& mX,
                                                  const T2& mMin) noexcept
    {
    ...
    template <typename T1, typename T2>
    inline constexpr Common<T1, T2> getClampedMax(const T1& mX,
                                                  const T2& mMax) noexcept
    {
    ...
    /// mMax.
    template <typename T1, typename T2, typename T3>
    inline constexpr Common<T1, T2, T3> getClamped(const T1& mX, const T2& mMin,
                                                   const T3& mMax) noexcept
    {
    ...
    template <typename T1, typename T2, typename T3>
    inline auto getCycledValue(const T1& mX, const T2& mMin,
                               const T3& mMax) noexcept
    {
        Common<T1, T2, T3> delta{mMax - mMin},
    ...
    template <typename T1, typename T2, typename T3>
    inline auto getRotatedDeg(const T1& mStart, const T2& mEnd,
                              const T3& mSpeed) noexcept
    {
        using CT = Common<T1, T2, T3>;
        CT diff{getCycledValue(getWrapDeg(mEnd) - getWrapDeg(mStart), -CT(180),
                               CT(180))};
    ...
    template <typename T1, typename T2, typename T3>
    inline constexpr auto getRotatedRad(const T1& mStart, const T2& mEnd,
                                        const T3& mSpeed) noexcept
    {
    ...
    /// columns.
    template <typename T1, typename T2, typename T3>
    inline constexpr Common<T1, T2, T3>
    get1DIdxFrom2D(const T1& mX, const T2& mY, const T3& mCols) noexcept
    {
    ...
    inline constexpr Common<T1, T2, T3, T4, T5>
    get1DIdxFrom3D(const T1& mX, const T2& mY, const T3& mZ, const T4& mCols,
    ...
    /// 3D" array.
    template <typename T1, typename T2, typename T3>
    inline auto get3DIdxFrom1D(const T1& mIdx, const T2& mCols,
                               const T3& mRows) noexcept
    {
    ...
    template <typename T1, typename T2>
    inline Common<T1, T2> getMod(const T1& mVal, const T2& mUB)
    {
        SSVU_ASSERT(mUB > 0);
    ...
    template <typename T1, typename T2, typename T3>
    inline Common<T1, T2, T3> getMod(T1 mVal, const T2& mLB,
                                     const T3& mUB) noexcept
    {
        SSVU_ASSERT(mLB < mUB);
    ...
    inline constexpr Common<T1, T2, T3, T4>
    getDistSquaredEuclidean(const T1& mX1, const T2& mY1, const T3& mX2,
                            const T4& mY2) noexcept
    {
    ...
    template <typename T1, typename T2, typename T3, typename T4>
    inline constexpr Common<T1, T2, T3, T4>
    getDistEuclidean(const T1& mX1, const T2& mY1, const T3& mX2,
                     const T4& mY2) noexcept
    {
    ...
    template <typename T1, typename T2, typename T3, typename T4>
    inline constexpr Common<T1, T2, T3, T4>
    getDistManhattan(const T1& mX1, const T2& mY1, const T3& mX2,
                     const T4& mY2) noexcept
    {
    ...
    template <typename T1, typename T2, typename T3, typename T4>
    inline constexpr Common<T1, T2, T3, T4>
    getDistChebyshev(const T1& mX1, const T2& mY1, const T3& mX2,
                     const T4& mY2) noexcept
    {
    ...
    template <typename T1, typename T2, typename T3, typename T4>
    inline constexpr Common<T1, T2, T3, T4>
    getRadTowards(const T1& mX1, const T2& mY1, const T3& mX2,
                  const T4& mY2) noexcept
    {
    ...
    template <typename T1, typename T2, typename T3, typename T4>
    inline constexpr Common<T1, T2, T3, T4>
    getDegTowards(const T1& mX1, const T2& mY1, const T3& mX2,
                  const T4& mY2) noexcept
    {
    ...
    template <typename T1, typename T2>
    inline constexpr Common<T1, T2> getDistRad(const T1& mA,
                                               const T2& mB) noexcept
    {
    ...
    template <typename T1, typename T2>
    inline constexpr Common<T1, T2> getDistDeg(const T1& mA,
                                               const T2& mB) noexcept
    {
    ...
    template <typename T1, typename T2, typename T3, typename T4, typename T5>
    inline constexpr Common<T1, T2, T3, T4, T5>
    getMap(const T1& mI, const T2& mIMin, const T3& mIMax, const T4& mOMin,
           const T5& mOMax) noexcept
    {
    ...
    /// @param mB Max value.
    template <typename T1, typename T2, typename T3>
    inline constexpr Common<T1, T2, T3> getLerp(const T1& mWeight, const T2& mA,
                                                const T3& mB) noexcept
    {
