...
namespace ssvu
{
    ...
    template <typename T1, typename T2>
    inline constexpr Common<T1, T2> getDistRad(
    ...
    template <typename T1, typename T2>
    inline constexpr Common<T1, T2> getDistDeg(
        const T1& mA, const T2& mB) noexcept
    {
    ...
    inline constexpr Common<T1, T2, T3, T4, T5> getMap(const T1& mI,
        const T2& mIMin, const T3& mIMax, const T4& mOMin,
