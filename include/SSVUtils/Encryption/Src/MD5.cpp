...
// 32 bits integer
            ...
            SSVU_INLINE std::string MD5::Calculate(const unsigned char* source,
                                                   uint32_t len)
            {
                MD5_CTX context;
    ...
    {                                                \
        ...
        (a) += (b);                                  \
            ...
            /* MD5 block update operation. Continues an MD5 message-digest
              ...
              context.
             */
            SSVU_INLINE void MD5Update(MD5_CTX* context,
             ...
             */
            SSVU_INLINE void MD5Final(unsigned char digest[16],
                                      MD5_CTX* context)
            {
             ...
             */
            SSVU_INLINE void MD5Transform(UINT4 state[4],
            ...
            /* Encodes input (UINT4) into output (unsigned char). Assumes len is
              a multiple of 4.
             */
            SSVU_INLINE void Encode(unsigned char* output, const UINT4* input,
                                    unsigned int len)
            {
                unsigned int i, j;
            ...
            /* Decodes input (unsigned char) into output (UINT4). Assumes len is
              a multiple of 4.
             */
            SSVU_INLINE void Decode(UINT4* output, const unsigned char* input,
                                    unsigned int len)
            {
                unsigned int i, j;
                for(i = 0, j = 0; j < len; ++i, j += 4)
            ...
            SSVU_INLINE void MD5_memcpy(POINTER output, POINTER input,
                                        unsigned int len)
            {
                unsigned int i;
             ...
             */
            SSVU_INLINE void MD5_memset(POINTER output, int value,
                                        unsigned int len)
            {
                unsigned int i;
