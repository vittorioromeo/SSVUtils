...
#define SSVU_BENCHMARK_LOG_SCOPE_EXIT(...) \
	::ssvu::Benchmark::Impl::LogScopeExit VRM_PP_CAT(__logScopeExit, __LINE__){__VA_ARGS__}
...
#define SSVU_BENCHMARK_RUN_GROUP_SCOPE_EXIT(...) \
	::ssvu::Benchmark::Impl::RunGroupScopeExit VRM_PP_CAT(__logGroupScopeExit, __LINE__){__VA_ARGS__}
...
#define SSVU_BENCHMARK_INIT_GROUP_SCOPE_EXIT(...) \
	::ssvu::Benchmark::Impl::InitGroupScopeExit VRM_PP_CAT(__initGroupScopeExit, __LINE__){__VA_ARGS__}
