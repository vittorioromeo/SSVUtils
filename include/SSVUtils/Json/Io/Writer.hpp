...
private:
    ...
    {
        if(!TWS::fmt) return;
        appendTo(out, Console::resetFmt(), Console::setColorFG(mColor),
    ...
    inline void repeatWithSeparator(TItr mBegin, TItr mEnd, TF1 mF1, TF2 mF2)
    {
