...
#define SSVJ_IMPL_SRLZ_ARR_IMPL_SEP_ARG(mX, ...)                     \
    VRM_PP_FOREACH_REVERSE(SSVJ_IMPL_SRLZ_ARR_IMPL_SEP_ARG_STEP, mX, \
                           __VA_ARGS__)
...
#define SSVJ_IMPL_SRLZ_OBJ_AUTO_IMPL_SEP_ARG(mX, ...)                     \
    VRM_PP_FOREACH_REVERSE(SSVJ_IMPL_SRLZ_OBJ_AUTO_IMPL_SEP_ARG_STEP, mX, \
                           __VA_ARGS__)
...
#define SSVJ_CNV_ARR_TEMPLATE(mTemplateArgs, mType, ...) \
    SSVJ_IMPL_CNV_WRAPPER(mType, (mTemplateArgs),        \
                          (SSVJ_SRLZ_ARR(mV, mX, __VA_ARGS__);))
