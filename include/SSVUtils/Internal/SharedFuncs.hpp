...
inline auto refreshImplLoop(std::size_t& mSizeNext, const TF1& mFAliveChk,
    const TF2& mFSwap, const TF3& mFDeinit) noexcept
{
    std::size_t iD{0}, iA{mSizeNext - 1};
...
template <typename TF1, typename TF2, typename TF3>
inline void refreshImpl(std::size_t& mSize, std::size_t& mSizeNext,
    const TF1& mFAliveChk, const TF2& mFSwap, const TF3& mFDeinit) noexcept
{
