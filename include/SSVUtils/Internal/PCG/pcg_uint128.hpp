...
#error Cannot find a function for uint64_t
    ...
    inline bitcount_t flog2(uint32_t v)
    {
        ...
        static const uint8_t multiplyDeBruijnBitPos[32] = {0, 9, 1, 10, 13, 21,
            2, 29, 11, 14, 16, 18, 22, 25, 3, 30, 8, 12, 20, 28, 15, 17, 24, 7,
    ...
    {
        static const uint8_t multiplyDeBruijnBitPos[32] = {0, 1, 28, 2, 29, 14,
            24, 3, 30, 22, 20, 15, 25, 17, 4, 8, 31, 27, 13, 23, 21, 19, 16, 7,
    ...
    uint_x4<UInt, UIntX2> operator*(
        const uint_x4<UInt, UIntX2>& a, const uint_x4<UInt, UIntX2>& b)
    {
    ...
    template <typename UInt, typename UIntX2>
    uint_x4<UInt, UIntX2> operator<<(
        const uint_x4<UInt, UIntX2>& v, const bitcount_t shift)
    {
        uint_x4<UInt, UIntX2> r = {0U, 0U, 0U, 0U};
