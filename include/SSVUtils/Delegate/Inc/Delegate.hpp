...
namespace ssvu
{
    ...
    public:
        ...
        {
            return Impl::DelegateHelper<TReturn, TArgs...>::exec(*this,
                                                                 mArgs...);
        }
    ...
    namespace Impl
    {
        ...
        struct DelegateHelper
        {
            inline static auto exec(Delegate<TReturn(TArgs...)>& mDelegate,
                                    TArgs... mArgs)
            {
        ...
        {
            inline static void exec(Delegate<void(TArgs...)>& mDelegate,
                                    TArgs... mArgs)
            {
