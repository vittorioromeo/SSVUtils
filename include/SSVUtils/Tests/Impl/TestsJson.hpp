...
SSVUT_TEST(SSVUJsonValTests3)
{
	...
	{
		using PP = Tpl<int, float, std::string, int, std::pair<double, int>, float, Tpl<int, int, int>>;
		PP p{10, 15.5f, "ULTRA SWAG"s, 22, std::pair<double, int>{10.5, 99}, 0.f, Tpl<int, int, int>{0, 1, 2}};
		EXEC_TEST_BASIC(PP, p)
	}
}
...
SSVUT_TEST(SSVUJsonValTests4)
{
	...
	{
		using PP = Tpl<std::vector<std::string>, std::pair<std::vector<int>, std::vector<float>>, int, std::vector<int>>;
