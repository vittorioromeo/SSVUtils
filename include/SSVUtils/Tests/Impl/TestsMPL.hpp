...
SSVUT_TEST(MPLTests)
{
	...
	SSVU_ASSERT_STATIC_NM(!List<PT0, PT1, PT2, PT1, PT0>::isUnique());
	SSVU_ASSERT_STATIC_NM(!List<PT0, PT0>::isUnique());
	SSVU_ASSERT_STATIC_NM(List<PT0, PT1, PT2>::isUnique());
	SSVU_ASSERT_STATIC_NM(List<>::isUnique());
