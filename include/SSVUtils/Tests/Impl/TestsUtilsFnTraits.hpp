...
#ifndef SSVU_TESTS_TESTSUTILSFNTRAITS
#define SSVU_TESTS_TESTSUTILSFNTRAITS
...
SSVUT_TEST(UtilsFnTraits)
{
	...
	SSVU_ASSERT_STATIC_NM(isSame<FnTraits<decltype(x2)>::Type, void(int, char)>());
	...
	SSVU_ASSERT_STATIC_NM(isSame<FnTraits<decltype(l2)>::Type, void(int, char)>());
