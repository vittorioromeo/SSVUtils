...
namespace ssvu
{
        ...
        namespace Impl
        {
            ...
            struct Dispatcher
            {
                ...
                inline static T getMap(const T& mI, const T& mIMin,
                                       const T& mIMax, const T& mOMin,
                                       const T& mOMax) noexcept
                {
                    return TKind<TEase<T>>::get()(mIMin + mI, mOMin,
                                                  mOMax - mOMin, mIMax - mIMin);
                }
            };
        }
    ...
    inline Common<T1, T2, T3> getEased(const T1& mI, const T2& mIMin,
                                       const T3& mIMax) noexcept
    {
    ...
    inline Common<T1, T2, T3, T4, T5>
    getMapEased(const T1& mI, const T2& mIMin, const T3& mIMax, const T4& mOMin,
