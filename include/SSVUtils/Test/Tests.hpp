...
{
	EXPECT(SSVU_PP_VA_NUM_ARGS() == 0);
	EXPECT(SSVU_PP_VA_NUM_ARGS(1) == 1);
	EXPECT(SSVU_PP_VA_NUM_ARGS(1, 1) == 2);
	EXPECT(SSVU_PP_VA_NUM_ARGS(1, 1, 1) == 3);
	EXPECT(SSVU_PP_VA_NUM_ARGS(1, 1, 1, 1) == 4);
	...
	EXPECT(SSVU_PP_CONCAT(15, 15) == 1515);
	EXPECT(SSVU_PP_CONCAT(15, 15, 15) == 151515);

	EXPECT(SSVU_PP_INCREMENT(1) == 2);
...

	{
		...
		SSVU_PP_FOREACH(SSVU_TEST_FOREFFECT,		SSVU_PP_EMPTY(),	1, 2, 3, 4)
...

	{
		...
		std::string s(SSVU_PP_STRINGIFYWITHCOMMAS(SSVU_PP_FOREACH(SSVU_TEST_FOREFFECT, SSVU_PP_EMPTY(), 1, 2, 3, 4)));
	...
	{
		EXPECT(SSVU_PP_TPL_GET(0, (1, 2, 3)) == 1);
		EXPECT(SSVU_PP_TPL_GET(1, (1, 2, 3)) == 2);
		EXPECT(SSVU_PP_TPL_GET(2, (1, 2, 3)) == 3);

		EXPECT(SSVU_PP_TPL_GET(0, SSVU_PP_TPL_MAKE(1, 2, 3)) == 1);
		EXPECT(SSVU_PP_TPL_GET(1, SSVU_PP_TPL_MAKE(1, 2, 3)) == 2);
		EXPECT(SSVU_PP_TPL_GET(2, SSVU_PP_TPL_MAKE(1, 2, 3)) == 3);

		EXPECT(SSVU_PP_TPL_GET(0, SSVU_PP_TPL_EXPLODE(((1, 2)))) == 1);
		EXPECT(SSVU_PP_STRINGIFYWITHCOMMAS(SSVU_PP_TPL_EXPLODE((1, 2))) == "1, 2");

		#define SSVU_TEST_CONCATENATED_TPLS SSVU_PP_TPL_CAT((1, 2), (3, 4))
		EXPECT(SSVU_PP_TPL_GET(0, SSVU_TEST_CONCATENATED_TPLS) == 1);
		EXPECT(SSVU_PP_TPL_GET(1, SSVU_TEST_CONCATENATED_TPLS) == 2);
		EXPECT(SSVU_PP_TPL_GET(2, SSVU_TEST_CONCATENATED_TPLS) == 3);
		EXPECT(SSVU_PP_TPL_GET(3, SSVU_TEST_CONCATENATED_TPLS) == 4);
		#undef SSVU_TEST_CONCATENATED_TPLS

		EXPECT(SSVU_PP_TPL_GET(1, SSVU_PP_TPL_CAT((1), (3))) == 3);

		#define SSVU_TEST_CONCATENATED_TPLS SSVU_PP_TPL_CAT((1), (1, 2), (3, 4), (4, 5, 6), (1))
		EXPECT(SSVU_PP_TPL_GET(0, SSVU_TEST_CONCATENATED_TPLS) == 1);
		EXPECT(SSVU_PP_TPL_GET(1, SSVU_TEST_CONCATENATED_TPLS) == 1);
		EXPECT(SSVU_PP_TPL_GET(2, SSVU_TEST_CONCATENATED_TPLS) == 2);
		EXPECT(SSVU_PP_TPL_GET(3, SSVU_TEST_CONCATENATED_TPLS) == 3);
		EXPECT(SSVU_PP_TPL_GET(4, SSVU_TEST_CONCATENATED_TPLS) == 4);
		EXPECT(SSVU_PP_TPL_GET(5, SSVU_TEST_CONCATENATED_TPLS) == 4);
		EXPECT(SSVU_PP_TPL_GET(6, SSVU_TEST_CONCATENATED_TPLS) == 5);
		EXPECT(SSVU_PP_TPL_GET(7, SSVU_TEST_CONCATENATED_TPLS) == 6);
		EXPECT(SSVU_PP_TPL_GET(8, SSVU_TEST_CONCATENATED_TPLS) == 1);
		#undef SSVU_TEST_CONCATENATED_TPLS

		EXPECT(SSVU_PP_TPL_SIZE((1, 2, 3)) == 3);
		EXPECT(SSVU_PP_TPL_SIZE((2)) == 1);
		EXPECT(SSVU_PP_TPL_SIZE((1, 2, 3, 1, 1)) == 5);
		EXPECT(SSVU_PP_TPL_SIZE(()) == 0);
	}
}
SSVU_TEST_END();
