...
{
	SSVUT_EXPECT(SSVPP_VA_NUM_ARGS() == 0);
	SSVUT_EXPECT(SSVPP_VA_NUM_ARGS(1) == 1);
	SSVUT_EXPECT(SSVPP_VA_NUM_ARGS(1, 1) == 2);
	SSVUT_EXPECT(SSVPP_VA_NUM_ARGS(1, 1, 1) == 3);
	SSVUT_EXPECT(SSVPP_VA_NUM_ARGS(1, 1, 1, 1) == 4);
	SSVUT_EXPECT(SSVPP_VA_NUM_ARGS(1, 1, 1, 1, 1) == 5);
	SSVUT_EXPECT(SSVPP_VA_NUM_ARGS(1, 1, 1, 1, 1, 1) == 6);

	SSVUT_EXPECT(SSVPP_STRINGIFY(SSVPP_CAT()) == "");
...

	{
		...
		SSVUT_EXPECT(SSVPP_STRINGIFYWITHCOMMAS(SSVPP_TPL_EXPLODE((1, 2))) == "1, 2");
