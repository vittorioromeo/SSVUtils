...
SSVU_TEST(PreprocessorTests)
{
	...
	{
		EXPECT(SSVPP_TPL_ELEM((1, 2, 3), 0) == 1);
		EXPECT(SSVPP_TPL_ELEM((1, 2, 3), 1) == 2);
		EXPECT(SSVPP_TPL_ELEM((1, 2, 3), 2) == 3);

		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_MAKE(1, 2, 3), 0) == 1);
		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_MAKE(1, 2, 3), 1) == 2);
		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_MAKE(1, 2, 3), 2) == 3);

		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_EXPLODE(((1, 2))), 0) == 1);
		EXPECT(SSVPP_STRINGIFYWITHCOMMAS(SSVPP_TPL_EXPLODE((1, 2))) == "1, 2");

		#define SSVU_TEST_CONCATENATED_TPLS SSVPP_TPL_CAT((1, 2), (3, 4))
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 0) == 1);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 1) == 2);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 2) == 3);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 3) == 4);
		#undef SSVU_TEST_CONCATENATED_TPLS

		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_CAT((1), (3)), 1) == 3);

		#define SSVU_TEST_CONCATENATED_TPLS SSVPP_TPL_CAT((1), (1, 2), (3, 4), (4, 5, 6), (1))

		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 0) == 1);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 1) == 1);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 2) == 2);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 3) == 3);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 4) == 4);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 5) == 4);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 6) == 5);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 7) == 6);
		EXPECT(SSVPP_TPL_ELEM(SSVU_TEST_CONCATENATED_TPLS, 8) == 1);

		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 0) == 1);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 1) == 6);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 2) == 5);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 3) == 4);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 4) == 4);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 5) == 3);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 6) == 2);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 7) == 1);
		EXPECT(SSVPP_TPL_ELEM_REVERSE(SSVU_TEST_CONCATENATED_TPLS, 8) == 1);
		...
		EXPECT(SSVPP_TPL_HEAD((1, 2, 3)) == 1);
		EXPECT(SSVPP_TPL_TAIL((1, 2, 3)) == 3);

		EXPECT(SSVPP_TPL_HEAD((1, 2)) == 1);
		EXPECT(SSVPP_TPL_TAIL((1, 2)) == 2);

		EXPECT(SSVPP_TPL_HEAD((1)) == 1);
		EXPECT(SSVPP_TPL_TAIL((1)) == 1);

		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_PUSH_FRONT((1, 2), 3), 0) == 3);
		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_PUSH_FRONT((1, 2), 3), 2) == 2);

		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_PUSH_BACK((1, 2), 3), 0) == 1);
		EXPECT(SSVPP_TPL_ELEM(SSVPP_TPL_PUSH_BACK((1, 2), 3), 2) == 3);
	}
...

	{
		...
		EXPECT(lambda1().first == 1);
		EXPECT(lambda1().second == 5);

		EXPECT(lambda2().first == 2);
		EXPECT(lambda2().second.first == 1.5f);
		EXPECT(lambda2().second.second == 2.5f);
