...
/// object sizes.
template <typename TBase, typename... Ts>
using PolyFixedRecVector =
Impl::BaseRecVector<TBase,
Impl::PolyRecyclerImpl<TBase, Impl::LayoutImpl::LHelperNoBool,
                    Impl::PolyFixedStorage<TBase,
                       Impl::LayoutImpl::LHelperNoBool, MPL::List<Ts...>>>>;
}
