...
namespace ssvu
{
    ...
    template <typename TBase>
    using PolyRecycler = Impl::PolyRecyclerImpl<
        TBase, Impl::LayoutImpl::LHelperNoBool,
    ...
    using PolyFixedRecycler = Impl::PolyRecyclerImpl<
        TBase, Impl::LayoutImpl::LHelperNoBool,
    ...
    template <typename TBase>
    using MonoManager = Impl::BaseManager<
        TBase, Impl::MonoRecyclerImpl<TBase, Impl::LayoutImpl::LHelperBool>>;

    /// @brief Memory recycler manager for multiple object types. Stores an
    /// additional bool in every object.
    template <typename TBase>
    using PolyManager = Impl::BaseManager<
        TBase, Impl::PolyRecyclerImpl<
                   TBase, Impl::LayoutImpl::LHelperBool,
    ...
    /// sizes.
    template <typename TBase, typename... Ts>
    using PolyFixedManager = Impl::BaseManager<
        TBase, Impl::PolyRecyclerImpl<
                   TBase, Impl::LayoutImpl::LHelperBool,
    ...
    template <typename TBase>
    using MonoRecVector = Impl::BaseRecVector<
        TBase, Impl::MonoRecyclerImpl<TBase, Impl::LayoutImpl::LHelperNoBool>>;

    /// @brief `std::vector` + recycler wrapper class multiple object types.
    /// Doesn't store additional data in the objects.
    template <typename TBase>
    using PolyRecVector = Impl::BaseRecVector<
        TBase, Impl::PolyRecyclerImpl<
                   TBase, Impl::LayoutImpl::LHelperNoBool,
                   Impl::PolyStorage<TBase, Impl::LayoutImpl::LHelperNoBool>>>;
    ...
    /// object sizes.
    template <typename TBase, typename... Ts>
    using PolyFixedRecVector = Impl::BaseRecVector<
        TBase,
        Impl::PolyRecyclerImpl<
            TBase, Impl::LayoutImpl::LHelperNoBool,
            Impl::PolyFixedStorage<TBase, Impl::LayoutImpl::LHelperNoBool,
                                   MPL::List<Ts...>>>>;
}
...
// TODO: fixed storage type that takes a variadic list of SizeT sizes as
